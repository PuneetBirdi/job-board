...
const Header = () => {
    return (
        <section className='h-screen bg-gradient-to-b from-purple-400 to-purple-600 flex flex-col justify-center items-center'>
            <div className='container h-2/3 flex flex-col justify-between items-center'>
                ...
                <form className='justify-self-center w-1/3 p-4 mt-12 mb-6 flex'>
                    ...
                    <button className="transition duration-200 ease-in-out focus:bg-gray-300 hover:bg-gray-300 bg-gray-200 px-3 rounded-r-md text-white font-bold">Search</button>
                </form>
